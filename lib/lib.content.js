...
const regexKappahlProductPage = /\/\d{5,}$/
const regexPolarnopyretProductPage = /-\d{6,}-\d{3,}$/
const regexReimaProductPage = /reima.com\/nb-NO\/products\//
...
function prodObjEurosko () {
  return {
    ...
    queryPart: '',
    URL: '',
    urlPart1: 'https://www.finn.no/recommerce/forsale/search?q=',
    urlPart2: '&sort=PRICE_ASC&for_rent=0&trade_type=1&trade_type=2',
    site: 'Didriksons',
    searchSite: 'FINN.no',
    searchResults: null,
...
const prodObjKattnakken = {
  type: 'CONTENT_BACKGROUND',
  title: '',
  queryPartReadable: '',
  queryPart: '',
  URL: '',
  urlPart1: 'https://www.finn.no/recommerce/forsale/search?brand=1954&q=',
  urlPart2: '&sort=PRICE_ASC&for_rent=0&trade_type=1&trade_type=2',
  site: 'Kattnakken',
  searchSite: 'FINN.no',
  searchResults: null,
...
function prodObjPolarnopyret () {
  return {
    ...
    queryPart: '',
    URL: '',
    urlPart1: 'https://www.finn.no/recommerce/forsale/search?brand=9309&q=',
    urlPart2: '&sort=PRICE_ASC&for_rent=0&trade_type=1&trade_type=2',
    site: 'Polarn\'O\'Pyret',
    searchSite: 'FINN.no',
    searchResults: null,
...
function prodObjReima () {
  return {
    ...
    queryPart: '',
    URL: '',
    urlPart1: 'https://www.finn.no/recommerce/forsale/search?brand=9329&q=',
    urlPart2: '&sort=PRICE_ASC&for_rent=0&trade_type=1&trade_type=2',
    site: 'Reima',
    searchSite: 'FINN.no',
    searchResults: null,
...
function extractAndPrepareEurosko (prodObj) {
  console.log('extracting...')
  const regexDidriksons = /^\p{Alpha}+/u
  prodObj.title = document.getElementsByTagName('h1')[0].textContent
  console.log(prodObj.title)
...
function extractAndPrepareKattnakken (prodObj) {
  const regexKattnakken = /.+(?=\n)/
  prodObj.title = regexKattnakken.exec(document.getElementsByTagName('h1')[0].textContent)[0]
  console.log(prodObj.title)
  prodObj.queryPartReadable = prodObj.title
  prodObj.queryPart = prodObj.queryPartReadable.replaceAll(' ', '+')
  prodObj.timeStamp = Date.now()
...
function extractAndPreparePolarnopyret (prodObj) {
  console.log('extracting...')
  prodObj.title = document.getElementsByTagName('h1')[0].textContent
  console.log(prodObj.title)
  prodObj.queryPartReadable = prodObj.title
...
function extractAndPrepareReima (prodObj) {
  ...
  prodObj.title = document.getElementsByTagName('h1')[0].textContent
  console.log(prodObj.title)
  prodObj.queryPartReadable = regexReima.exec(prodObj.title)[0]
  prodObj.queryPart = prodObj.queryPartReadable.replaceAll(' ', '+')
  prodObj.timeStamp = Date.now()
  // Create URL and delete key/values not needed
  prodObj.URL = encodeURI(prodObj.urlPart1 + prodObj.queryPart + prodObj.urlPart2)
...
export {
  ...
  regexDidriksonsProductPage, regexEuroskoProductPage, regexGullkornProductPage, regexHellyhansenProductPage, regexKappahlProductPage, regexPolarnopyretProductPage, regexReimaProductPage,
  productUrlCheck,
  finnBrandIds,
  prodObjIkea,
  ...
  prodObjBergans, prodObjDidriksons, prodObjEurosko, prodObjGullkorn, prodObjHellyhansen, prodObjKappahl, prodObjKattnakken, prodObjPolarnopyret, prodObjReima,
  ...
  extractAndPrepareBergans, extractAndPrepareDidriksons, extractAndPrepareEurosko, extractAndPrepareGullkorn, extractAndPrepareHellyhansen, extractAndPrepareKappahl, extractAndPrepareKattnakken, extractAndPreparePolarnopyret, extractAndPrepareReima,
  sendObj
}
