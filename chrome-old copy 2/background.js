...
// ###    B: Notify browser when productHits > 0                             ###
// ###    C: Search Finn, send response to popup script and notify if        ###
// ###       results                                                         ###
// ###    D: Set                        ###
// ###    E: Set data to browser.storage.local                               ###
// ###    F: Get data from browser.storage.local and send to popup           ###
// ###    G: Listener to message from content scripts                        ###
// ###    H: Hello background! Just checking                                 ###

// ###    Example of object that is sent from content-script:                ###
// prodObj = {
//   type: 'CONTENT_BACKGROUND',
//   title: '<PRODUCT-TITLE>',
//   queryPartReadable: '<TEXT-PART-OF-QUERY>',
//   URL: '<FINN-url>',
//   site: 'IKEA',
//   searchSite: 'FINN',
...
// ###    D: Listener to message from content scripts and popup              ###
